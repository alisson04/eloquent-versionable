...
trait Versionable
{
    ...
    public function getTable(): string
    {
        ...
        if (
            ...
            ($this->isVersioningEnabled() && ! in_array($calledBy, $methods))
        ) {
    ...
    public function newInstance($attributes = [], $exists = false)
    {
        ...
        // during the hydration of new objects via the Eloquent query builder
        // instances.
    ...
    private function guessVersioningClassName(): string
    {
        ...
        return $namespace . '\\Versioning\\'  . $shortName . 'Versioning';
    }
}
